...
{
    public Transform platformBorderRight, platformBorderLeft, player, enemyShip;
    ...
    void PrepareThePlayer()
    {
        PlayerManager.Instance.playerActor.playerSoldierOfficer.StartProcess();
    }
}
